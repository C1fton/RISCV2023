...
/* INSERT YOUR CODE FROM HERE */
    ...
    /// Encode "Sll2add rd, rs1, rs2" into this object.
    bool encodeSll2add(unsigned rd, unsigned rs1, unsigned rs2);

    /// Encode "Sll1add1 rd, rs1, rs2" into this object.
    bool encodeSll1add1(unsigned rd, unsigned rs1, unsigned rs2);

    /// Encode "Sll3add rd, rs1, rs2" into this object.
    bool encodeSll3add(unsigned rd, unsigned rs1, unsigned rs2);
