...
/* INSERT YOUR CODE FROM HERE */  
  else if(funct7 == 2)
    {
      ...
      // sll2add
      if (funct3 == 5) return instTable_.getEntry(InstId::sll2add);
      // sll1add1
      if (funct3 == 6) return instTable_.getEntry(InstId::sll1add1);
      // sll3add
      if (funct3 == 7) return instTable_.getEntry(InstId::sll3add);
    }
